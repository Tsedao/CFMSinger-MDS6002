...
dataset2path = {
    "Opencpop": "/data/zitao/2022-InterSpeech-Opencpop",
    "M4Singer": "/data/zitao/m4singer",
}

# Please configure the root path to save your data and model
root_path = "/data/zitao/CFMSinger"
...
parser = ArgumentParser(description="Singing Voice Conversion")
...
parser.add_argument(
    "--save", type=str, default="/data/zitao/CFMSinger/ckpts/debug", help="folder to save the final model"
)
